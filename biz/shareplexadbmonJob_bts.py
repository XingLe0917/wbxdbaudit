...
EXTRA_DB=['RACAFWEB','TTA35','TTA136']
...
class ShareplexAdbmon_bts(WbxJob):
    def start(self):
        self.src_dbs=""
        self.tgt_dbs =""
    ...
    def main(self):
        ...
        try:
            ...
            rows = self.auditdao.getDBTnsInfo_2_bts()
            shareplexinfos = self.auditdao.getShareplexinfos_bts(self.src_dbs,self.tgt_dbs)
            wbxadbmons = self.auditdao.getWbxadbmons_bts()
