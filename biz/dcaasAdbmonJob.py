...
class DCassAdbmon(WbxJob):
    ...
    def main(self):
        ...
        try:
            ...
            rows = self.auditdao.getDBTnsInfoByDcaas()
            shareplexinfos = self.auditdao.getShareplexinfosByDCaas(self.src_dbs,self.tgt_dbs)
            wbxadbmons = self.auditdao.getWbxadbmonsByDcaas()
        ...
        self.depotdb_url= tns_vo['AUDITDB_sjdbormt011']
        ...
        with ThreadPoolExecutor(max_workers=20) as t:
            ...
            for future in as_completed(all_task):
                ...
                if (num == len(src_db_tns_sql)):
                    ...
                    logging.debug("update all src finish!")
                    # query tgt logtime
    ...
    def update_wbxadbmon(self,update_wbxadbmon_list):
        ...
        try:
            srcconn = cx_Oracle.connect("depot/depot@"+self.depotdb_url)
    ...
    def test(self):
        self.auditdao = wbxauditdbdao(self.depot_connectionurl)
        self.src_dbs = "RACBTW2"
        self.tgt_dbs = "BTDCAAS"
        self.type = "update"
        self.main()
